...
End-to-end sales analytics pipeline - SQL, Python, Power BI 
...
-What are customer purchasing patterns and basket combinations?

-Where are the opportunities to increase revenue and reduce waste?

#Tools & Technologies

DATA EXTRACTION -	SQL; Exploration, filtering, aggregations

DATA PROCESSING - Python; (pandas, matplotlib, seaborn)	Cleaning, EDA, feature engineering

VISUALISATION - Power BI;	Executive dashboard, 3-page report

AI INTEGRATION - Claude, Gemini;	AI-assisted analysis,	Insight generation, recommendation structuring 
...
Page 1 - Dashboard;	KPI cards, top/bottom products, revenue by day, basket analysis, category breakdown

Page 2 - Recommendations;	Strategic, inventory, and marketing recommendations

Page 3 - Action Plan;	Product action table, customer segment analysis, expected impact 
